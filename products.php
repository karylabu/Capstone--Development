...
$categories = array_column(db_all("SELECT DISTINCT category FROM products"), 'category');
?>
...
<div class="category-tabs">
  <a href="products.php?cat=all" class="category-tab <?= $filterCat=='all'?'active':'' ?>">All</a>
  <a href="products.php?cat=cakes" class="category-tab <?= $filterCat=='cakes'?'active':'' ?>">Cakes</a>
  <a href="products.php?cat=meals" class="category-tab <?= $filterCat=='meals'?'active':'' ?>">Meals</a>
</div>
...
<?php if(strtolower($p['name']) === 'cake customization'): ?>
  <a href="customize.php" class="btn" style="text-decoration:none;display:block;text-align:center;">
    Customize
  </a>
<?php else: ?>
